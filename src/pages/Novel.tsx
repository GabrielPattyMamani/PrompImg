                        ...
                        <>
                          {chapterParts.map((part, partIdx) => {
                            ...
                            async function handleSummaryBlur() {
                              ...
                              if (!error) {
                                setSavedSummary(summary)
                                handleSummaryUpdate(part.id, summary)
                              }
                            }

                            return (
                              <div key={part.id} className="bg-white/2 border border-white/8 rounded-lg overflow-hidden">
                                {/* Part header */}
                                ...
                                <div className="flex gap-1 p-2 border-t border-white/8">
                                  ...
                                  <button
                                    onClick={() => setViewing({ type: 'part', item: part, orderNum: partIdx + 1 })}

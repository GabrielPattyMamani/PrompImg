        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {parts.length > 0 && (
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-amber-700/80 hover:bg-amber-700 text-amber-100 rounded-xl font-medium text-sm transition-colors"
            >
          ...
          >
            ...
            {tab === 'contexts' ? 'Añadir contexto' : 'Añadir parte'}
          </button>
        </div>
      </div>

...
interface Props {
  album: ImageAlbum
  onClose: () => void
  onUpdated: (album: ImageAlbum) => void
}

export default function EditAlbumModal({ album, onClose, onUpdated }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#1a1a22] border border-white/10 rounded-2xl p-6 w-full max-w-md shadow-2xl">
        <h2 className="text-white font-semibold text-lg mb-5">Editar carpeta</h2>
